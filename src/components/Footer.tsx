        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Building brands and growing influence through strategic digital marketing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">123 Business Street, Marketing City, MC 12345</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@rysonicmedia.com</span>
              </li>
            </ul>
          </div>
        </div>
