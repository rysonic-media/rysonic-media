...
export default function Home({ onNavigate }: HomeProps) {
  ...
  const caseStudies = [
    {
      ...
      solution: 'Integrated social media and influencer marketing campaign',
      results: [
    ...
    },
    {
      ...
      industry: 'E-commerce',
      challenge: 'Poor conversion rates on paid ads',
      solution: 'Optimized ad targeting and landing page redesign',
      results: [
  ...
  const testimonials = [
    {
      name: 'Sarah Johnson',
      company: 'Founder, BeautyBox Co.',
      text: 'Rysonic Media transformed our social media presence. Their strategic approach increased our engagement by 400% in just 3 months!',
      rating: 5,
    },
    {
      name: 'Michael Chen',
      company: 'CEO, TechStart Inc.',
      text: 'The ROI we achieved with Rysonic Media exceeded all expectations. Their performance advertising expertise is unmatched.',
      rating: 5,
    },
    {
      name: 'Emily Rodriguez',
      company: 'Marketing Director, FitLife',
      text: 'Working with Rysonic Media has been a game-changer. They truly understand how to build brands that resonate with audiences.',
      rating: 5,
    },
  ];
  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Stay ahead of the curve with these emerging social media trends that will shape the digital marketing landscape.',
      date: 'Mar 10, 2024',
    ...
    },
    {
      ...
      excerpt: 'Discover the essential elements of creating a memorable brand that connects with your target audience.',
      date: 'Mar 5, 2024',
  ...
  const faqs = [
    {
      ...
      answer: 'We specialize in social media marketing, performance advertising, brand development, analytics & reporting, influencer marketing, and growth strategy. Our comprehensive approach ensures all aspects of your digital presence work together seamlessly.',
    },
    {
      question: 'How long does it take to see results?',
      answer: 'While some improvements can be seen within weeks, sustainable growth typically takes 3-6 months. We focus on building long-term success rather than quick fixes, ensuring your brand grows steadily and authentically.',
    },
    {
      question: 'Do you work with small businesses?',
      answer: 'Absolutely! We work with businesses of all sizes, from startups to established enterprises. Our strategies are tailored to your specific needs, goals, and budget.',
    },
    {
      question: 'What makes Rysonic Media different?',
      answer: 'Our data-driven approach combined with creative excellence sets us apart. We don\'t just run campaigns; we build comprehensive strategies that align with your business goals and deliver measurable results.',
    },
    {
      question: 'How do you measure success?',
      answer: 'Success is measured through key performance indicators (KPIs) specific to your goals, including engagement rates, conversion rates, ROI, brand awareness metrics, and revenue growth. We provide detailed monthly reports and analytics.',
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Build Your Brand.{' '}
                <span className="text-[#d80000]">Grow Your Influence.</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Rysonic Media helps businesses grow using social media marketing and performance advertising.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-xl border-2 border-gray-100 hover:border-[#d80000] transition-all duration-300 hover:shadow-lg group"
              >
          ...
          <div className="text-center mt-12">
            <button
              ...
              className="text-[#d80000] font-semibold hover:underline flex items-center gap-2 mx-auto"
            >
      ...
      <section id="portfolio" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <button
              onClick={() => onNavigate('portfolio')}
              className="bg-[#d80000] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#b00000] transition-colors inline-flex items-center gap-2"
            >
            ...
            {blogPosts.map((post, index) => (
              <article key={index} className="bg-white rounded-xl overflow-hidden border-2 border-gray-100 hover:border-[#d80000] transition-all duration-300 hover:shadow-lg group cursor-pointer">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#d80000] transition-colors">
                    {post.title}
                  </h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to know about working with Rysonic Media
            </p>
          </div>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
